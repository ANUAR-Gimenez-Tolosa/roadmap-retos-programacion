...
print(f"Multiplicaciones: 10 * 3 = {10 * 3}")
...
print(f"igualdad: 10 == 3 es {10 == 3}")#la igualdad matemática es con dos signos (==)
...
print(f"my_number is my_new-number es { my_number is my_new_number}")
print(f"my_number is not my_new-number es { my_number is not my_new_number}")
...
if my_string == "MoureDev":
    ...
    print("my_string no es 'MoureDev' ni 'Bris'") 
